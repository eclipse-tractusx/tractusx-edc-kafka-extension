...
A simple Kafka Producer Application which creates EDC assets, Kaka  Topics and demo data to a Kafka Broker.

DockerHub: <https://hub.docker.com/r/tractusx/kafka-producer>

Eclipse Tractus-X product(s) installed within the image:

## Tractus-X EDC Kafka Producer
