...
*/}}
{{- define "producer-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "producer-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "producer-app.secretName" -}}
{{- if .Values.secrets.secretName }}
{{- .Values.secrets.secretName }}
{{- else }}
{{- include "producer-app.fullname" . }}-secrets
{{- end }}
{{- end }}